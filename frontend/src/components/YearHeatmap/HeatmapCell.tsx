...
export const HeatmapCell: React.FC<HeatmapCellProps> = React.memo(({ cell, onHover }) => {
  ...
  if (!cell.date || !cell.iso) {
    return (
      <div
        className="w-2 h-2 rounded-sm bg-slate-800/50 shrink-0"
  ...
  return (
    <div
      className={`w-2 h-2 rounded-sm ${cls} cursor-default shrink-0 hover:ring-2 hover:ring-slate-400 hover:ring-offset-1 hover:ring-offset-slate-900`}
